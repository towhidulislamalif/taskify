        ...
        >
          ...
          <div className="flex justify-center md:block gap-4">
            {user?.uid ? (
              ...
              <Link to="/sign-in">
                <button className="px-4 py-2 tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                  Sign in
                </button>
              </Link>
            )}
